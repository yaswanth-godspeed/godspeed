...
exports.GSDataSource = exports.GSEventSource = exports.GSDataSourceAsEventSource = exports.GSContext = exports.GSStatus = exports.GSCloudEvent = exports.GSActor = void 0;
...
const metrics_1 = __importDefault(require("@godspeedsystems/metrics"));
// loaders
...
Object.defineProperty(exports, "GSDataSourceAsEventSource", { enumerable: true, get: function () { return sources_1.GSDataSourceAsEventSource; } });
// validators
const jsonSchemaValidation_1 = require("./core/jsonSchemaValidation");
const logger_1 = require("./logger");
const swagger_1 = require("./router/swagger");
class Godspeed {
    constructor(params = {}) {
        this.datasources = {};
        this.eventsources = {};
    ...
    initilize() {
        this._loadDefinitions()
            ...
            logger_1.logger.info(`[Dev Server][Running] ('${status.split(' ')[0]}' event source, '${status.split(' ')[1]}' port).`);
        }))
            .catch((error) => {
    ...
    _loadDatasources() {
        return __awaiter(this, void 0, void 0, function* () {
            logger_1.logger.info('[START] Load data sources from %s', this.folderPaths.datasources);
            let datasources = yield (0, datasourceLoader_1.default)(this.folderPaths.datasources);
            logger_1.logger.debug('data sources %o', datasources);
            logger_1.logger.info('[END] Load data sources');
            return datasources;
        });
    }
    ;
    _loadEventsources() {
        return __awaiter(this, void 0, void 0, function* () {
            logger_1.logger.info('[START] Load event sources from %s', this.folderPaths.eventsources);
            let eventsources = yield (0, eventsourceLoader_1.default)(this.folderPaths.eventsources, this.datasources);
            logger_1.logger.debug('event sources %o', eventsources);
            logger_1.logger.info('[END] event sources.');
            return eventsources;
        });
    }
    ;
    subscribeToEvents() {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            const httpEvents = {};
            try {
                for (var _e = true, _f = __asyncValues(Object.keys(this.events)), _g; _g = yield _f.next(), _a = _g.done, !_a;) {
                    _c = _g.value;
                    _e = false;
                    try {
                        let route = _c;
                        ...
                        if (eventSourceName === 'http') {
                            httpEvents[eventKey] = Object.assign({}, this.events[eventKey]);
                        }
                        const processEventHandler = yield this.processEvent(this);
                        yield eventSource.subscribeToEvent(route, this.events[eventKey], processEventHandler);
                    }
                    finally {
                        _e = true;
                    }
            ...
            if ((_d = httpEventSource === null || httpEventSource === void 0 ? void 0 : httpEventSource.config) === null || _d === void 0 ? void 0 : _d.docs) {
                const _httpEvents = (0, swagger_1.generateSwaggerJSON)(httpEvents, this.definitions, httpEventSource.config);
                logger_1.logger.info('HTTP event source: %o', _httpEvents);
                // @ts-ignore
                httpEventSource.client.use(httpEventSource.config.docs.endpoint || '/api-docs', swagger_ui_express_1.default.serve, swagger_ui_express_1.default.setup(_httpEvents));
            }
            if (process.env.OTEL_ENABLED == 'true') {
                // @ts-ignore
                httpEventSource.client.get('/metrics', (req, res) => __awaiter(this, void 0, void 0, function* () {
                    let prismaMetrics = '';
                    for (let ds in this.datasources) {
                        // @ts-ignore
                        if (this.datasources[ds].config.type === 'prisma') {
                            // @ts-ignore
                            prismaMetrics += yield this.datasources[ds].client.$metrics.prometheus({
                                globalLabels: { server: process.env.HOSTNAME, datasource: `${ds}` },
                            });
                        }
                    }
                    let appMetrics = yield metrics_1.default.register.metrics();
    ...
    processEvent(local) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return (event, eventConfig) => __awaiter(this, void 0, void 0, function* () {
                ...
                (0, logger_1.initializeChildLogger)({});
                ...
                const ctx = new interfaces_1.GSContext(config, datasources, event, {}, {}, logger_1.logger, logger_1.childLogger);
                ...
                try {
                    ...
                    logger_1.childLogger.info('eventHandlerStatus: %o', eventHandlerStatus);
